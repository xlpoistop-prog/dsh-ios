...
async function encode(pipeline, mediaType, quality) {
	const encoded = mediaType === "image/png" ? pipeline.png() : mediaType === "image/jpeg" ? pipeline.jpeg({ quality }) : void 0;
...
/**
* Build the lazy quality ladder for one prepared pipeline: PNG keeps a source
* alpha channel losslessly, everything else is JPEG.
...
const REQUEST_IMAGE_TRANSFORM_VERSION = "request-image-v7";
